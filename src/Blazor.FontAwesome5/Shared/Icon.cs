...
public class Icon : ITransformIcon, IIcon
{
    ...
    public Icon Size(IconSize size) => new Icon(
        Style,
        Name,
        size,
        _fixedWidth,
    ...
    public Icon FixedWidth(bool fixedWith = true) => new Icon(
        Style,
        Name,
        _size,
        fixedWith,
    ...
    public Icon Spin(bool spin = true) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Pulse(bool pulse = true) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Border(bool border = true) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Inverse(bool inverse = true) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Scale(double scale = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Grow(double scale = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Shrink(double scale = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Horizontal(double horizontal = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Left(double left = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Right(double right = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Vertical(double vertical = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Up(double up = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Down(double down = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Rotate(IconRotate rotate) => rotate switch
    {
    ...
    public Icon Rotate(double rotate = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon RotateRight(double rotate = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon RotateLeft(double rotate = 0) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Flip(IconFlip flip = IconFlip.None) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon Mask(Icon? mask) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon RemoveMask() => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon CssClass(string? cssClass) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public Icon CssStyle(string? cssStyle) => new Icon(
        Style,
        Name,
        _size,
        _fixedWidth,
    ...
    public static string ToString(IconSize size, bool stack) => ( size, stack ) switch
    {
    ...
    public static string ToPrefix(IconStyle style) => style switch
    {
        IconStyle.Solid   => "fas",
    ...
    public static string ToPrefix(Icon icon) => ToPrefix(icon.Style);
