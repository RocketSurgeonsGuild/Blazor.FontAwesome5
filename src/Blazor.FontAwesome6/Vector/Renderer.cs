...
//        };
    ...
    {
        return string.Join("", Render(iconDefinition, parameters).Select(x => x.ToHtml()));
    }
    ...
    private string GetStyleString(ImmutableDictionary<string, string> styles)
    {
    ...
    {
        return attributes.SetItem("style", GetStyleString(styles));
    }
