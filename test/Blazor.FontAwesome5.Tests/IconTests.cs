...
namespace Rocket.Surgery.Blazor.FontAwesome5.Tests
{
    public class IconTests : LoggerTest
    {
        ...
        public void Should_Render_A_Transformed_Icon()
        {
            ...
            icon
               ...
               .Grow(3)
               .ToIcon().Should().Be(
                    "<i class=\"far fa-adjust\" data-fa-transform=\"grow-3.00 shrink-2.00 rotate--40.00 up-12.00 down-4.00 left-4.00 right-1.00\"></i>"
                );
        }
    ...
    //     public void Should_Support_Implicit_Conversion_From_Known_Enum()
    //     {
    //         var icon = _host.AddComponent<FaIcon>(
    //             new Dictionary<string, object>()
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Far.Adjust,
    //             }
    //         );
    //         icon.GetMarkup().Should().Be("<i class=\"far fa-adjust\"></i>");
    //     }
    //
    //     [Fact]
    //     public void Should_Support_Implicit_Conversion_From_Custom_Enum()
    ...
    //             new Dictionary<string, object>()
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Custom.Name,
    //             }
    //         );
    //         icon.GetMarkup().Should().Be("<i class=\"far fa-adjust\"></i>");
    //     }
    ...
    //     {
    //         _host.AddComponent<FaIcon>().GetMarkup().Should().Be("<i class=\"fas fa-bomb\"></i>");
    //     }
    //
    //     [Fact]
    //     public void Should_Render_An_Icon()
    ...
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Far.Adjust,
    //                 [nameof(FaIcon.Rotate)] = ( -40 ).ToString(),
    //                 [nameof(FaIcon.Left)] = 2.ToString(),
    //                 [nameof(FaIcon.Down)] = 4.ToString(),
    //                 [nameof(FaIcon.Right)] = 1.ToString(),
    //                 [nameof(FaIcon.Up)] = 12.ToString(),
    //                 [nameof(FaIcon.Grow)] = 6.ToString(),
    //                 [nameof(FaIcon.Shrink)] = 4.ToString(),
    //             }
    //         );
    //         icon.GetMarkup().Should().Be(
    ...
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Far.Adjust,
    //                 [nameof(FaIcon.Flip)] = iconFlip,
    //             }
    //         );
    //         icon.GetMarkup().Should().Be(expected);
    //     }
    //
    //     [Theory]
    //     [InlineData(IconSize.ExtraSmall, "<i class=\"far fa-adjust fa-xs\"></i>")]
    ...
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Far.Adjust,
    //                 [nameof(FaIcon.FixedWidth)] = true,
    //             }
    //         );
    //         icon.GetMarkup().Should().Be("<i class=\"far fa-adjust fa-fw\"></i>");
    //     }
    //
    //     [Fact]
    //     public void Should_Render_A_Spin_Icon()
    ...
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Far.Adjust,
    //                 [nameof(FaIcon.Spin)] = true,
    //             }
    //         );
    //         icon.GetMarkup().Should().Be("<i class=\"far fa-adjust fa-spinner\"></i>");
    //     }
    //
    //     [Fact]
    //     public void Should_Render_A_Pulse_Icon()
    ...
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Far.Adjust,
    //                 [nameof(FaIcon.Pulse)] = true,
    //             }
    //         );
    //         icon.GetMarkup().Should().Be("<i class=\"far fa-adjust fa-pulse\"></i>");
    //     }
    //
    //     [Fact]
    //     public void Should_Render_A_Border_Icon()
    ...
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Far.Adjust,
    //                 [nameof(FaIcon.Border)] = true,
    //             }
    //         );
    //         icon.GetMarkup().Should().Be("<i class=\"far fa-adjust fa-border\"></i>");
    //     }
    //
    //     [Fact]
    //     public void Should_Render_A_Inverse_Icon()
    ...
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Far.Adjust,
    //                 [nameof(FaIcon.Inverse)] = true,
    //             }
    //         );
    //         icon.GetMarkup().Should().Be("<i class=\"far fa-adjust fa-inverse\"></i>");
    //     }
    //
    //     [Fact]
    //     public void Should_Render_A_Mask_Icon()
    ...
    //             {
    //                 [nameof(FaIcon.Icon)] = (Icon)Far.Adjust,
    //                 [nameof(FaIcon.Mask)] = (Icon)Fad.Analytics,
    //             }
    //         );
    //         icon.GetMarkup().Should().Be("<i class=\"far fa-adjust\" data-fa-mask=\"fad fa-analytics\"></i>");
    //     }
    //
    //     [Theory]
    //     [InlineData(IconPull.None, "<i class=\"far fa-adjust\"></i>")]
