    ...
    public class FaIconTests : LoggerTest
    {
        ...
        public void Should_Render_A_Transformed_Icon()
        {
            ...
            icon.Markup.Should().Be(
                "<i class=\"fa-regular fa-adjust\" data-fa-transform=\"grow-6.00 shrink-4.00 rotate--40.00 up-12.00 down-4.00 left-2.00 right-1.00\"></i>"
            );
        }
        ...
        public void Should_Render_A_FixedWith_Icon()
        {
            ...
            icon.Markup.Should().Be("<i class=\"fa-regular fa-adjust fa-fw\"></i>");
        }
        ...
        public void Should_Render_A_Spin_Icon()
        {
            ...
            icon.Markup.Should().Be("<i class=\"fa-regular fa-adjust fa-spin\"></i>");
        }
        ...
        public void Should_Render_A_Spin_Reverse_Icon()
        {
            ...
            icon.Markup.Should().Be("<i class=\"fa-regular fa-adjust fa-spin fa-spin-reverse\"></i>");
        }
        ...
        public void Should_Render_A_Pulse_Icon()
        {
            ...
            icon.Markup.Should().Be("<i class=\"fa-regular fa-adjust fa-spin-pulse\"></i>");
        }
        ...
        public void Should_Render_A_Pulse_Reverse_Icon()
        {
            ...
            icon.Markup.Should().Be("<i class=\"fa-regular fa-adjust fa-spin-pulse fa-spin-reverse\"></i>");
        }
        ...
        public void Should_Render_A_Border_Icon()
        {
            ...
            icon.Markup.Should().Be("<i class=\"fa-regular fa-adjust fa-border\"></i>");
        }
        ...
        public void Should_Render_A_Inverse_Icon()
        {
            ...
            icon.Markup.Should().Be("<i class=\"fa-regular fa-adjust fa-inverse\"></i>");
        }
        ...
        public void Should_Render_A_Mask_Icon()
        {
            ...
            icon.Markup.Should().Be("<i class=\"fa-regular fa-adjust\" data-fa-mask=\"fa-duotone fa-analytics\"></i>");
        }
