...
public class FaSvgIconTests : LoggerTest
{
    ...
    public Task Should_Render_A_Mask_Icon() =>
        Verify(
            _host.RenderComponent<FaIcon>(
                builder => builder
                          .Add(x => x.Icon, FaSolid.Adjust)
                          .Add(x => x.Mask, FaSolid.Link)
            )
        );

    public FaSvgIconTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper, LogLevel.Information) { }
    ...
    private class IconTransformData : IconTheory
    {
        public IconTransformData()
        {
            ...
            AddIcon(
                z => z.Add(x => x.Icon, FaSolid.Chain.FixedWidth())
            );

            AddIcon(
                z => z.Add(x => x.Icon, FaSolid.Chain).Add(x => x.FixedWidth, true)
            );
            AddIcon(
                z => z.Add(x => x.Icon, FaSolid.Chain.FixedWidth()).Add(x => x.FixedWidth, false)
            );

            AddIcon(
                z => z.Add(x => x.Icon, FaSolid.Chain.FixedWidth(false))
            );

            AddIcon(
                z => z.Add(x => x.Icon, FaSolid.Chain).Add(x => x.FixedWidth, false)
            );
            AddIcon(
                z => z.Add(x => x.Icon, FaSolid.Chain.FixedWidth(false)).Add(x => x.FixedWidth, true)
            );
            AddIcon(
                z => z.Add(
                    x => x.Icon,
