...
using Rocket.Surgery.Blazor.FontAwesome6.Free.Categories;
...
namespace Rocket.Surgery.Blazor.FontAwesome6.Tests
{
    public class IconTests : LoggerTest
    {
        ...
        class IconTransformData : IconTheory
        {
            public IconTransformData()
            {
                var bogus = new Faker() { Random = new Randomizer(3) };
                AddIcon(FaSolid
                   .Barcode
        ...
        class IconBorderAndPullData : IconTheory
        {
            public IconBorderAndPullData()
            {
                var bogus = new Faker() { Random = new Randomizer(5) };
                AddIcon(
                    FaSolid.Bank
                           .Border(
                                true,
        ...
        class IconTheory : TheoryData<string, Icon>
        {
        ...
        class IconAnimationData : IconTheory
        {
            private static string[] AnimationDirections = ["normal", "reverse", "alternate", "alternate-reverse",];
            private static string[] AnimationTimingFunctions = ["ease", "ease-in", "ease-out", "ease-in-out", "linear", "step-start", "step-end",];

            public IconAnimationData()
            {
                var bogus = new Faker() { Random = new Randomizer(6) };
