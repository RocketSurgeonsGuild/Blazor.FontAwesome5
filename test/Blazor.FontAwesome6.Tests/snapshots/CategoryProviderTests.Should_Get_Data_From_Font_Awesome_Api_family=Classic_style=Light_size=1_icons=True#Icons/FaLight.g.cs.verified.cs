...
public static partial class FaLight
{
    ...
    /// </summary>
    public static SvgIcon _0 => f__0 ??= new SvgIcon(IconFamily.Classic, IconStyle.Light, "0", "[unicode]", 320, 512, "[path]");
    private static SvgIcon? f__00;
    /// <summary>
    /// <a href="https://fontawesome.com/icons/00?f=classic&amp;s=light">00</a>
    /// </summary>
    public static SvgIcon _00 => f__00 ??= new SvgIcon(IconFamily.Classic, IconStyle.Light, "00", "[unicode]", 640, 512, "[path]");
}