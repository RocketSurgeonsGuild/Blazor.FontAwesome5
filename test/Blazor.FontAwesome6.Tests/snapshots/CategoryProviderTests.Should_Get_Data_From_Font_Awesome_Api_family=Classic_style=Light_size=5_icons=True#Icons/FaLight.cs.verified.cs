...
public static partial class FaLight
{
    ...
    /// </summary>
    public static SvgIcon ArrowDownFromDottedLine => f_ArrowDownFromDottedLine ??= new SvgIcon(IconFamily.Classic, IconStyle.Light, "arrow-down-from-dotted-line", "[unicode]", 448, 512, "[path]");
    ...
    /// </summary>
    public static SvgIcon ArrowDownToDottedLine => f_ArrowDownToDottedLine ??= new SvgIcon(IconFamily.Classic, IconStyle.Light, "arrow-down-to-dotted-line", "[unicode]", 448, 512, "[path]");
}