...
public static partial class FaLight
{
    ...
    /// </summary>
    public static Icon DownLeftAndUpRightToCenter => f_DownLeftAndUpRightToCenter ??= new Icon(IconFamily.Classic, IconStyle.Light, "down-left-and-up-right-to-center", "[unicode]");
    ...
    /// </summary>
    public static Icon UpRightAndDownLeftFromCenter => f_UpRightAndDownLeftFromCenter ??= new Icon(IconFamily.Classic, IconStyle.Light, "up-right-and-down-left-from-center", "[unicode]");
}