...
public static partial class FaDuotoneLight
{
    ...
    /// </summary>
    public static SvgIcon DownLeftAndUpRightToCenter => f_DownLeftAndUpRightToCenter ??= new SvgIcon(IconFamily.Duotone, IconStyle.Light, "down-left-and-up-right-to-center", "[unicode]", 512, 512, "[path]");
    ...
    /// </summary>
    public static SvgIcon UpRightAndDownLeftFromCenter => f_UpRightAndDownLeftFromCenter ??= new SvgIcon(IconFamily.Duotone, IconStyle.Light, "up-right-and-down-left-from-center", "[unicode]", 512, 512, "[path]");
}