...
public static partial class FaLight
{
    ...
    /// </summary>
    public static Icon AlbumCollectionCirclePlus => f_AlbumCollectionCirclePlus ??= new Icon(IconFamily.Classic, IconStyle.Light, "album-collection-circle-plus", "[unicode]");
    ...
    /// </summary>
    public static Icon AlbumCollectionCircleUser => f_AlbumCollectionCircleUser ??= new Icon(IconFamily.Classic, IconStyle.Light, "album-collection-circle-user", "[unicode]");
}