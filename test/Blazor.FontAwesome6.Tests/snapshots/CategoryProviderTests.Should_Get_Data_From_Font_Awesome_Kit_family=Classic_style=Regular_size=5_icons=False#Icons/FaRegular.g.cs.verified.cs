...
public static partial class FaRegular
{
    ...
    /// </summary>
    public static Icon ArrowDownFromDottedLine => f_ArrowDownFromDottedLine ??= new Icon(IconFamily.Classic, IconStyle.Regular, "arrow-down-from-dotted-line", "[unicode]");
    ...
    /// </summary>
    public static Icon ArrowDownToDottedLine => f_ArrowDownToDottedLine ??= new Icon(IconFamily.Classic, IconStyle.Regular, "arrow-down-to-dotted-line", "[unicode]");
}