...
public static partial class FaSharpDuotoneThin
{
    ...
    /// </summary>
    public static SvgIcon ArrowDownFromDottedLine => f_ArrowDownFromDottedLine ??= new SvgIcon(IconFamily.SharpDuotone, IconStyle.Thin, "arrow-down-from-dotted-line", "[unicode]", 448, 512, "[path]");
    ...
    /// </summary>
    public static SvgIcon ArrowDownToDottedLine => f_ArrowDownToDottedLine ??= new SvgIcon(IconFamily.SharpDuotone, IconStyle.Thin, "arrow-down-to-dotted-line", "[unicode]", 448, 512, "[path]");
}