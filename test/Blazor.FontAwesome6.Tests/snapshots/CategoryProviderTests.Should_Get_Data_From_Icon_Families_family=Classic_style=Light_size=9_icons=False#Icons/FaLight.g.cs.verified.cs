...
public static partial class FaLight
{
    ...
    /// </summary>
    public static Icon ArrowDownLeftAndArrowUpRightToCenter => f_ArrowDownLeftAndArrowUpRightToCenter ??= new Icon(IconFamily.Classic, IconStyle.Light, "arrow-down-left-and-arrow-up-right-to-center", "[unicode]");
    ...
    /// </summary>
    public static Icon ArrowUpRightAndArrowDownLeftFromCenter => f_ArrowUpRightAndArrowDownLeftFromCenter ??= new Icon(IconFamily.Classic, IconStyle.Light, "arrow-up-right-and-arrow-down-left-from-center", "[unicode]");
}