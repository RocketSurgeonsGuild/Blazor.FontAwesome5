...
public static partial class FaLight
{
    ...
    /// </summary>
    public static SvgIcon ArrowDownLeftAndArrowUpRightToCenter => f_ArrowDownLeftAndArrowUpRightToCenter ??= new SvgIcon(IconFamily.Classic, IconStyle.Light, "arrow-down-left-and-arrow-up-right-to-center", "[unicode]", 512, 512, "[path]");
    ...
    /// </summary>
    public static SvgIcon ArrowUpRightAndArrowDownLeftFromCenter => f_ArrowUpRightAndArrowDownLeftFromCenter ??= new SvgIcon(IconFamily.Classic, IconStyle.Light, "arrow-up-right-and-arrow-down-left-from-center", "[unicode]", 512, 512, "[path]");
}