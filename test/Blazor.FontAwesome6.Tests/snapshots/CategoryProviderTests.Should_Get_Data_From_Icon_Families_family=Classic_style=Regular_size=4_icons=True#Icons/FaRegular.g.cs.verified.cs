...
public static partial class FaRegular
{
    ...
    /// </summary>
    public static SvgIcon AlbumCollectionCirclePlus => f_AlbumCollectionCirclePlus ??= new SvgIcon(IconFamily.Classic, IconStyle.Regular, "album-collection-circle-plus", "[unicode]", 640, 512, "[path]");
    ...
    /// </summary>
    public static SvgIcon AlbumCollectionCircleUser => f_AlbumCollectionCircleUser ??= new SvgIcon(IconFamily.Classic, IconStyle.Regular, "album-collection-circle-user", "[unicode]", 640, 512, "[path]");
}