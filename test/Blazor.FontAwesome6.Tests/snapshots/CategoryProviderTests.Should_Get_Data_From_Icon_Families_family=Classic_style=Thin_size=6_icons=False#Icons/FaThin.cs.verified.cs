...
public static partial class FaThin
{
    ...
    /// </summary>
    public static Icon HouseFloodWaterCircleArrowRight => f_HouseFloodWaterCircleArrowRight ??= new Icon(IconFamily.Classic, IconStyle.Thin, "house-flood-water-circle-arrow-right", "[unicode]");
    ...
    /// </summary>
    public static Icon PersonWalkingDashedLineArrowRight => f_PersonWalkingDashedLineArrowRight ??= new Icon(IconFamily.Classic, IconStyle.Thin, "person-walking-dashed-line-arrow-right", "[unicode]");
}