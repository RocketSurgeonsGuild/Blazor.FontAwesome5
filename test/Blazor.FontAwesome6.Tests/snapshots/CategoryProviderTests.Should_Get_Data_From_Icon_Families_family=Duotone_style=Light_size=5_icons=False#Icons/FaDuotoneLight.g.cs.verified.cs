...
public static partial class FaDuotoneLight
{
    ...
    /// </summary>
    public static Icon ArrowDownFromDottedLine => f_ArrowDownFromDottedLine ??= new Icon(IconFamily.Duotone, IconStyle.Light, "arrow-down-from-dotted-line", "[unicode]");
    ...
    /// </summary>
    public static Icon ArrowDownToDottedLine => f_ArrowDownToDottedLine ??= new Icon(IconFamily.Duotone, IconStyle.Light, "arrow-down-to-dotted-line", "[unicode]");
}