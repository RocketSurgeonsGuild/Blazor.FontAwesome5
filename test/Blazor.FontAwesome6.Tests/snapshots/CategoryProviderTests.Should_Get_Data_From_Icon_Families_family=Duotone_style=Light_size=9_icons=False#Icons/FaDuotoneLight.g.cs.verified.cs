...
public static partial class FaDuotoneLight
{
    ...
    /// </summary>
    public static Icon ArrowDownLeftAndArrowUpRightToCenter => f_ArrowDownLeftAndArrowUpRightToCenter ??= new Icon(IconFamily.Duotone, IconStyle.Light, "arrow-down-left-and-arrow-up-right-to-center", "[unicode]");
    ...
    /// </summary>
    public static Icon ArrowUpRightAndArrowDownLeftFromCenter => f_ArrowUpRightAndArrowDownLeftFromCenter ??= new Icon(IconFamily.Duotone, IconStyle.Light, "arrow-up-right-and-arrow-down-left-from-center", "[unicode]");
}