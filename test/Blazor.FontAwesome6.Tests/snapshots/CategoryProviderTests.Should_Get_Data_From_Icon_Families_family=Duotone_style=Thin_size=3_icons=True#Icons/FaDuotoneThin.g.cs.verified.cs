...
public static partial class FaDuotoneThin
{
    ...
    /// </summary>
    public static SvgIcon AlbumCirclePlus => f_AlbumCirclePlus ??= new SvgIcon(IconFamily.Duotone, IconStyle.Thin, "album-circle-plus", "[unicode]", 576, 512, "[path]");
    ...
    /// </summary>
    public static SvgIcon AlbumCircleUser => f_AlbumCircleUser ??= new SvgIcon(IconFamily.Duotone, IconStyle.Thin, "album-circle-user", "[unicode]", 576, 512, "[path]");
}