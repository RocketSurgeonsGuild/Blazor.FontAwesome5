...
public static partial class FaSharpDuotoneThin
{
    ...
    /// </summary>
    public static SvgIcon AlbumCirclePlus => f_AlbumCirclePlus ??= new SvgIcon(IconFamily.SharpDuotone, IconStyle.Thin, "album-circle-plus", "[unicode]", 576, 512, "[path]");
    ...
    /// </summary>
    public static SvgIcon AlbumCircleUser => f_AlbumCircleUser ??= new SvgIcon(IconFamily.SharpDuotone, IconStyle.Thin, "album-circle-user", "[unicode]", 576, 512, "[path]");
}