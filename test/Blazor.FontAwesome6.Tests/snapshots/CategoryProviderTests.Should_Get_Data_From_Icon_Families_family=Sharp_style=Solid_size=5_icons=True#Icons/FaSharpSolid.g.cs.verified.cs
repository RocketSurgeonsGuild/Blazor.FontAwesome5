...
public static partial class FaSharpSolid
{
    ...
    /// </summary>
    public static SvgIcon ArrowDownFromDottedLine => f_ArrowDownFromDottedLine ??= new SvgIcon(IconFamily.Sharp, IconStyle.Solid, "arrow-down-from-dotted-line", "[unicode]", 448, 512, "[path]");
    ...
    /// </summary>
    public static SvgIcon ArrowDownToDottedLine => f_ArrowDownToDottedLine ??= new SvgIcon(IconFamily.Sharp, IconStyle.Solid, "arrow-down-to-dotted-line", "[unicode]", 448, 512, "[path]");
}